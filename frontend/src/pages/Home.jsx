  ...
  return (
    <div>
      <motion.main className="flex flex-col items-center mt-40 h-screen bg-white space-y-8" variants={container} initial="hidden" animate="visible">
        <motion.h1 className='text-8xl font-bold' variants={item}>Spotiy Thing</motion.h1>
        ...
        <motion.button className='flex space-y-0 bg-[#00C407] text-white font-bold text-4xl px-20 py-10 rounded-full hover:bg-green-600 hover:scale-110 hover:cursor-pointer' variants={item}>Analyse</motion.button>
      </motion.main>
    </div>
  )
}
